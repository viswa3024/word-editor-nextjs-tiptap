...
// https://github.com/AgeeeDev/react-text-editor/blob/main/package.json

export default function WordEditor() {
  const editorRef = useRef(null)
  const contentRef = useRef<string>('') // keep content in ref (not state)
  const [_, forceUpdate] = useState(0)  // only for re-render on blur if needed
